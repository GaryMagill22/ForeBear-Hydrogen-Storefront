        ...
        <div className="sm:py-24 newsLetterContainer">
            <div className="sm:px-6 lg:px-10">
                <div className="relative isolate overflow-hidden bg-gray-900 px-8 py-24 shadow-2xl sm:rounded-3xl sm:px-24 sm:py-32">
                    ...
                    <form className="relative mx-auto mt-8 max-w-xs gap-x-4 newsLetterInputs flex flex-col items-center">
                        ...
                        <input
                            ...
                            type="text"
                            required
                            className="min-w-4 rounded-md border-3 bg-white/5 px-3.5 py-2 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-white sm:text-sm sm:leading-6"
                        ...
                        <input
                            ...
                            type="text"
                            required
                            className="min-w-3 rounded-md border-0 bg-white/5 px-3.5 py-2 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-white sm:text-sm sm:leading-6"
                        ...
                        <input
                            ...
                            type="email"
                            required
                            className="min-w-4 rounded-md border-0 bg-white/5 px-3.5 py-2 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-white sm:text-sm sm:leading-6"
                            placeholder="Email"
                        />
                        <button
                            type="submit"
...
// DESKTOP VERSION
{/* <div className=" sm:py-24 newsLetterContainerDesktop">
